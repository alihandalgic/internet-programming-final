...
<body>
    ...
    <div class="product_section layout_padding margin_0">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <h1 class="choose_text">sıkça sorulan sorular</h1>
            ...
            <?php
                ...
                ?>
                          ...
                          <p class="lorem_text1"><img src="images/right-icon.png"><span class="right_icon"><?php echo $value['baslik']?></span></p>
    ...
    <div class="copyright_section">
      <div class="container">
        <p class="copyright_text">2019 All Rights Reserved. Design by <a href="https://html.design">Alihan Dalgıç</a></p>
      </div>
    </div>
