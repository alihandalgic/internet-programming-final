...
<body>
    ...
    <div class="contact_section layout_padding">
      <div class="container-fluid">
        <div class="contact_text"><b>İletİşİm</b> <span class="contact_us_text"></span></div>
        <div class="contact_section2">
          <div class="rowq">
            <div class="col-md-6" style="margin: 0 auto;">
              ...
              <form action="">
                <input type="text" class="mail_text" placeholder="İsim" name="isim">
                <input type="mail" class="mail_text" placeholder="Email" name="email">
                <input type="number" class="mail_text" placeholder="Telefon Numarası" name="numara">
                <textarea class="massage_text" placeholder="Mesaj" rows="5" id="comment" name="mesaj"></textarea>
                <button type="submit" name="submitEkle" class="btn btn-success send_bt" style="width: 90px;">Ekle</button>
              </form>




                <div class="Locations_text"><img src="images/map-icon.png"><span class="map_icon">Lokasyon</span></div>
                <div class="Locations_text"><img src="images/call-icon.png"><span class="map_icon">+01 9876543210</span></div>
                <div class="Locations_text"><img src="images/mail-icon.png"><span class="map_icon">qfit@gmail.com</span></div>
              </div>
            </div>
          </div>
        </div>
