...
<!-- site metas -->
<title>QFit | Kütahya Spor Salonu</title>
...
<body>
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <h1 class="your_text">Hazırsın <br>Hadi Başlayalım... </h1>
              <div class="start_bt">
                <div class="read_bt"><a href="kayit.php">Bize Katıl</a></div>
              </div>
            </div>
      ...
      <div class="banner_section_2">
            ...
            <?php 
                            ...
                            //echo $username;
                              ...
                              foreach($veri as $row){
                                echo"<div class=\"col-lg-4 col-sm-12 padding_0\">
                                  <div class=\"box_main\">
                                    <div class=\"internet_icon\">".$row[1]."</div>
                                    <h4 class=\"broadband_text\">".$row[2]."</h4>
                                    <p class=\"many_text\">".$row[3]."</p>
                                  </div>
                                </div>
    ...
    <div class="about_section layout_padding">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <div class="image_1"><img src="images/img-11.png"></div>
          </div>
          <div class="col-md-6">
          ...
          <?php 
                            ...
                            //echo $username;
                              ...
                              ->fetchAll();
                            ?>
            <h1 class="live_text"><?php echo $veri[0][1];?></h1>
            <p class="lorem_text"><li><?php echo $veri[0][2];?></li></p>
            <div class="online_bt_main">
              <div class="read_bt1"><a href="about.php">Dahası</a></div>
            </div>
          </div>
        </div>
      </div>
